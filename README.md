...
make脚手架
```sh
➜  cloud-manage git:(master) ✗ make help
...
2. 添加配置文件(默认读取位置: etc/cloud-manage.toml)
```sh
$ 编辑样例配置文件 etc/cloud-manage.toml.book
$ mv etc/cloud-manage.toml.book etc/cloud-manage.toml
```
