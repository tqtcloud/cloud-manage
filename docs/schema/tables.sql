...
CREATE TABLE IF NOT EXISTS `bill_raw` (
    ...
    `sale_price` float(10,2) NOT NULL COMMENT '官网价',
    `save_cost` float(10,2) NOT NULL COMMENT '优惠金额 ',
    `real_cost` float(10,2) NOT NULL COMMENT '应付金额',
    `credit_pay` float(10,2) NOT NULL COMMENT '信用额度支付金额',
    `voucher_pay` float(10,2) NOT NULL COMMENT '代金券抵扣',
    `cash_pay` float(10,2) NOT NULL COMMENT '现金抵扣',
    `storedcard_pay` float(10,2) NOT NULL COMMENT '储值卡抵扣',
    `outstanding_amount` float(10,2) NOT NULL COMMENT '欠费金额',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `bill_resource` (
    `vendor` tinyint(1) NOT NULL COMMENT '厂商',
    `year` int(11) NOT NULL COMMENT '账单年份',
    `month` int(11) NOT NULL COMMENT '账单月份',
    `owner_id` varchar(200)  NOT NULL COMMENT '账号id',
...
CREATE TABLE IF NOT EXISTS `bill_share` (
    ...
    `real_cost` float(10,2) NOT NULL COMMENT '分摊金额',
...
CREATE TABLE IF NOT EXISTS `bill_summary` (
    ...
    `year` int(11) NOT NULL COMMENT '账单年份',
    `month` int(11) NOT NULL COMMENT '账单月份',
    `real_cost` float(10,2) NOT NULL COMMENT '账单金额',
    `delta_cost` float(10,2) NOT NULL COMMENT '同步增长金额',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `metric_month` (
    `resource_id` varchar(64) NOT NULL COMMENT '资源Id',
    `metric_id` int(10) unsigned NOT NULL COMMENT '指标Id',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `resource_rds` (
    `resource_id` varchar(64) NOT NULL COMMENT '资源Id',
